...
# Open file
filename = "C:\\Users\\Ikaro\\Desktop\\Ap_reverso-Clara_Beatriz-2023-09-18\\controle\\RL\\Final_results.h5"
save_results = "C:/Users/Ikaro/Desktop/Ap_reverso-Clara_Beatriz-2023-09-18/6-OHDA/results"
...
latency_trial_av = np.zeros(8,)
latency_trial_err = np.zeros(8,)
x = []
count = 0;

for ii in np.arange(6,8,1):
...
latency_day_av = np.zeros(2,)
latency_day_err = np.zeros(2,)
x = []
count = 0;
...
# Loop to extract each day and trial separatelly
speed_trial_av = np.zeros(8,)
speed_trial_err = np.zeros(8,)
x = []
count = 0;
...
speed_day_av = np.zeros(2,)
speed_day_err = np.zeros(2,)
x = []
count = 0;
...
# Loop to extract each day and trial separatelly
p_err_trial_av = np.zeros(8,)
p_err_trial_err = np.zeros(8,)
s_err_trial_av = np.zeros(8,)
s_err_trial_err = np.zeros(8,)
x = []
count = 0;
...
p_err_day_av = np.zeros(2,)
p_err_day_err = np.zeros(2,)
s_err_day_av = np.zeros(2,)
s_err_day_err = np.zeros(2,)
x = []
count = 0;
...
# Loop to extract each day and trial separatelly
distance_trial_av = np.zeros(8,)
distance_trial_err = np.zeros(8,)
x = []
count = 0;
...
distance_day_av = np.zeros(2,)
distance_day_err = np.zeros(2,)
x = []
count = 0;
...
# Loop to extract each day and trial separatelly
spatial_trial_av = np.zeros(8,)
serial_trial_av = np.zeros(8,)
random_trial_av = np.zeros(8,)
...
# ###################################### 8 distance for each Day
spatial_day_av = np.zeros(2,)
serial_day_av = np.zeros(2,)
random_day_av = np.zeros(2,)
x = []
count = 0;
