...
for it in range(len(filename)):
    ...
    big_plot_LD(body_part_matrix_body_centre, centroid_coords, position_each_vertex, maze_info_pixel, inst_speed_entire, maze_regions_dict, bp_pos_on_region, save_filename_plot, trial_name=trial_name, trial_data=data, show=True, fps=fps)
