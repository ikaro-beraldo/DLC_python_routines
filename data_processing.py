...
# Function to exclude the Data_frame rows past the established time limit
def exclude_f_past_duration(df, trial_duration=5, fps=30):
    ...
    if df_length > max_duration:
        ...
        # If total time is lower than the trial duration, the corrected_df will be the original df
        corrected_df = df
